...
\begin{theorem}[Kouno, Motegi, and Shibuya] Let $K$ be a knot in $S^3$ and $c$ an unknot linked with $K$. If $c$ is not a meridian of $K$, then there are at most finitely many integers $n$ such that $K_{V,n}\simeq K$. 
\end{theorem}

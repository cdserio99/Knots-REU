...
Given a knot $K\in S^3$, we say that $p/q$  is a {\it characterizing slope} for $K$  if the oriented homeomorphism type of the manifold obtained by $p/q$-surgery on $K$ determines $K$ uniquely up to ambient isotopy. In this paper, we denote ambient isotopy by $\simeq$ and oriented homeomorphism by $\cong$.  

...
Note that in our context, $(0,0)$-surgery on $K_0'\cup c'$ always results in $S^3$ with its surgery dual link $c\cup K$. We can thus simplify the lemma as: $c'$ being a meridian of $K_0'$ implies that $c$ is a meridian to $K$. Hence, we obtain the following corollary from the contrapositive of the simplified lemma. 

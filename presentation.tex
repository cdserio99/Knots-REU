...
\begin{document}
	...
	\begin{frame}
		\frametitle{Knots in the 3-sphere}
		\begin{definition}
			A \textit{knot} $K$ is the image of a smooth embedding of the circle $S^1$ into the $3$-sphere $S^3$. In particular, $K$ is diffeomorphic to $S^1$.
		\end{definition}
		\begin{definition}

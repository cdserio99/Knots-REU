...
\end{frame}
	...
	\begin{frame}
		...
		\pause
		\begin{figure}
			\includegraphics[width=\textwidth]{handle slide}
			\caption{Handle slide}
		\end{figure}
	\end{frame}
	...
	\begin{frame}
		...
		\pause
		\begin{figure}
			\includegraphics[width=\textwidth]{rolfsen twist}
			\caption{Rolfsen twist}
		\end{figure}
	\end{frame}
	...
	\begin{frame}
		...
		\pause
		\begin{figure}
			\includegraphics[width=\textwidth]{slam dunk}
			\caption{Slam dunk}
		\end{figure}
	\end{frame}
...
\end{frame}
	...
	\begin{frame}
		\frametitle{Characterizing slopes}
		\begin{itemize}
		\item Let $K$ be a knot. Then $p/q$ is a \textit{characterizing slope} for $K$ if $S^3_{p/q}(K')$ is not homeomorphic to $S^3_{p/q}(K)$ for any knot $K'\ne K$.
		\pause
		\item The following theorem shows that for a certain type of knot, most rational slopes are characterizing.
		\end{itemize}
		\pause
		\begin{theorem}[Ni--Zhang, 2014]
			For the torus knot $T_{r,s}$, any slope $p/q>\frac{30}{67}\hs(r^2-1)(s^2-1)$ is characterizing.
		\end{theorem}
	\end{frame}
	...
	\begin{frame}
		...
		\pause
		\begin{itemize}
		\item Our work shows that for a certain type of knot, most integer slopes are non-characterizing!
		\end{itemize}
	\end{frame}
